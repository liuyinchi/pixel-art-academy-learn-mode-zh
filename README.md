...
4. **维护者补翻译**：如果游戏更新后需要处理新增英文，双击 **`补充翻译.bat`**：
   - 脚本自动提取新增的未翻译内容
   - 自动调用 AI 筛选并翻译玩家可见文本
   - 自动合并翻译并重新应用汉化
...
自动补翻译是维护者工具，默认隐藏，不建议普通玩家自己处理。游戏更新后如果出现新增英文，推荐由维护者检查更新内容、确认提取规则，再补充翻译并发布新版补丁。

### GUI 维护者工具

1. 打开 **`Pixel Art Academy 汉化补丁.exe`**
2. 点击 **显示维护者工具**
3. 填入 **API Key**；需要确认输入内容时，可点击 API Key 输入框旁边的 **显示/隐藏**
4. 按需修改 **Base URL** 和 **模型**
5. 点击 **自动补翻译并安装**
